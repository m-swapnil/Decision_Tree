...
conn_string = (
    ...
    .format(user="postgres",     # username
            pw="password",    # password
            db="loandefault")    # database name
)
...
credit = pd.read_csv(r"C:\Users\Swapnil Mishra\Desktop\DS\DT_flask_final_v2\DT_flask_final_v2\credit.csv")

# Load the data to PostgreSQL (replace the table if it already exists)
